...
export const appProjects: App[] = [
  {
    title: "PocketChange",
    subtitle: "(iOS)",
    description: "Application for engaging in the PocketChange digital neighbourhood marketplaces in Toronto. Built in React Native, the front end uses GraphQL to interface with SQL and MongoDB databases."
  },
  {
    title: "ClearCast",
    subtitle: "(iOS)",
